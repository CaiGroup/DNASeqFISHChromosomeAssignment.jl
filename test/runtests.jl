...
res = assign_chromosomes(far_chrms, r, r, sig, r)#, optimizer=CPLEX.Optimizer)
...
res = assign_chromosomes(close_chrms, r, r, sig, r)#, min_size, min_prop_unique, dbscan_min_pnts)#, CPLEX.Optimizer)
